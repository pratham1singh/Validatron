...
public class AllowedValuesChar implements ConstraintValidator<AllowedValues, Character> {
    ...
    public boolean isValid(Character ch, ConstraintValidatorContext context) {
        return Arrays.asList(this.allowedValues).contains(String.valueOf(ch));
    }
}
